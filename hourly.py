...
def get_hourly_entries_and_exits(entries_and_exits):
    ...
    '''
    return entries_and_exits.groupby('UNIT')['ENTRIESn', 'EXITSn'].apply(get_hourly)


def get_hourly(cumulative_data):
    # print cumulative_data.dtype
    return cumulative_data - cumulative_data.shift()
